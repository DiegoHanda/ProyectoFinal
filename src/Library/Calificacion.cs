...
{
    public int Value {get; set;}    //Algunas de estas clases fueron separadas desde conceptos mas abstractos. Creando clases que tengan resposabilidades especificas
